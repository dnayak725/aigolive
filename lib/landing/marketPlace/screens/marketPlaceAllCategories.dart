...
class MarketPlaceAllCategories extends StatefulWidget {
  @override
  _MarketPlaceAllCategoriesState createState() =>
      _MarketPlaceAllCategoriesState();
}

class _MarketPlaceAllCategoriesState extends State<MarketPlaceAllCategories> {
                              ...
                              return GestureDetector(
                                onTap: () async {
                                  ...
                                  if (streamList[index].subCatList.isEmpty) {
                                    await Provider.of<
                                                MarketBrowseByCategoryProvider>(
                                            context,
                                            listen: false)
                                        .reset();
                                    Navigator.push(
                      ...
                      Container(
                        ...
                        child: GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return GestureDetector(
                              onTap: () {
                                Provider.of<MarketBrowseByCategoryProvider>(
                                        context,
                                        listen: false)
                                    .reset();
                                Navigator.push(

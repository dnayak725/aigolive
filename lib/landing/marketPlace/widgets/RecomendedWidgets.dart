...
class RecommendedPLWidgets extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<RecommendedProductListProvider>(
      builder: (context, recommendedProvider, child) {
        List<MKProductModel> productList =
            recommendedProvider.recommendedProductList;
        print("Mahi object" + productList.toString());
        var status = recommendedProvider.listFetchingStatus;
        if (status == "fetching") {

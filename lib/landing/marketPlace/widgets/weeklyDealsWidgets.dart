...
class WeeklyDealsWidgets extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<WeeklyDealsProvider>(
      builder: (context, weeklyDealsProvider, child) {
        List<MKProductModel> productList =
            weeklyDealsProvider.weeklyDealsProductList;
        var status = weeklyDealsProvider.listFetchingStatus;
        if (status == "fetching") {
              ...
              : GridView.builder(
                  ...
                  itemBuilder: (ctx, index) {
                    return GestureDetector(
                      onTap: () async {
                        await Provider.of<ProductDetailsProvider>(context,
                                listen: false)
                            .reset();
                        Navigator.push(
                          context,
